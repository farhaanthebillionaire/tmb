    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 pb-8">
        ...
        <div className="prose prose-lg max-w-none text-foreground">
          ...
          <p>By accessing or using Track My Bite (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of the terms, then you may not access the Service. These Terms apply to all visitors, users, and others who access or use the Service.</p>
          ...
          <p>Track My Bite does not claim any ownership rights in any User Content and nothing in these Terms will be deemed to restrict any rights that you may have to use and exploit your User Content. You are solely responsible for all your User Content. You represent and warrant that you own all your User Content or you have all rights that are necessary to grant us the license rights in your User Content under these Terms.</p>

          <h2 className="text-xl font-semibold text-primary mt-4">6. AI Features and Disclaimer</h2>
          <p>The AI-powered features, including but not limited to plate analysis for calorie and nutritional estimation, and mood-food insights, provide estimates and suggestions for informational purposes only. These features are not a substitute for professional medical, dietary, or nutritional advice. Always consult with a qualified healthcare provider or registered dietitian for any health concerns or before making any decisions related to your health, diet, or treatment. Track My Bite makes no warranties regarding the accuracy, completeness, or reliability of the AI-generated information.</p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>To impersonate or attempt to impersonate Track My Bite, a Track My Bite employee, another user, or any other person or entity.</li>
          </ul>
          ...
          <p>THE SERVICE IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. TRACK MY BITE MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF THEIR SERVICES, OR THE INFORMATION, CONTENT OR MATERIALS INCLUDED THEREIN. YOU EXPRESSLY AGREE THAT YOUR USE OF THESE SERVICES, THEIR CONTENT, AND ANY SERVICES OR ITEMS OBTAINED FROM US IS AT YOUR SOLE RISK.</p>
          ...
          <p>These Terms shall be governed and construed in accordance with the laws of the jurisdiction in which Track My Bite operates, without regard to its conflict of law provisions.</p>
